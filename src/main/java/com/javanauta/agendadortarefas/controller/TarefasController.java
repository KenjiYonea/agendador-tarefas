...
public class TarefasController {
    ...
    @GetMapping
    public ResponseEntity<List<TarefasDTO>> buscaUsuarioPorEmail (@RequestHeader("Authorization") String token){

        return ResponseEntity.ok(tarefasService.buscaTerefasPorEmail(token));
    }
